...
if (isset($_POST['subStep']) && !isset($_GET['a']) && $_SESSION['lockout'] != true)
{
	switch($_POST['subStep'])
	{
		...
		case 3:
			...
			if ($_POST['userID'] == '' || $_POST['key'] == '') header("location: ../login.php.php");
...
<?php switch($show) {
    ...
    <h2>Password Recovery</h2>
    <p>An email has been sent to you with instructions on how to reset your password. <br /><br /><a href="../login.php">Return</a> to the login page. </p>
